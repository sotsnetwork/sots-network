...
const portfolioData = {
  ...
  projects: [
    {
      ...
      category: "blockchain",
      liveUrl: "https://horizon.xyz",
      githubUrl: "https://github.com/horizon-platform"
    },
    {
      id: "2",
  ...
  contact: {
    ...
    socialLinks: [
      {
        name: "GitHub",
        url: "https://github.com/horizon-platform",
        icon: (
      ...
      {
        name: "LinkedIn",
        url: "https://linkedin.com/company/horizon-platform",
        icon: (
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      {
        name: "Twitter",
        url: "https://twitter.com/horizonplatform",
        icon: (
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      {
        name: "YouTube",
        url: "https://youtube.com/@horizonplatform",
        icon: (
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      {
        name: "TikTok",
        url: "https://tiktok.com/@horizonplatform",
        icon: (
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
