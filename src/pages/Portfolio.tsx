...
const portfolioData = {
  name: "SOTS NETWORK",
  tagline: "Web Solutions to Creators & Businesses",
  ...
  projects: [
    {
      ...
      category: "blockchain",
      liveUrl: "https://sotsnetwork.xyz",
      githubUrl: "https://github.com/sots-network"
    },
    {
      id: "2",
  ...
  contact: {
    ...
    newsletter: "newsletter@sotsnetwork.xyz",
    socialLinks: [
      {
        name: "GitHub",
        url: "https://github.com/sots-network",
        icon: (
      ...
      {
        name: "LinkedIn",
        url: "https://linkedin.com/company/sots-network",
        icon: (
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      {
        name: "Twitter",
        url: "https://twitter.com/sotsnetwork",
        icon: (
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      {
        name: "YouTube",
        url: "https://youtube.com/@sotsnetwork",
        icon: (
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      {
        name: "TikTok",
        url: "https://tiktok.com/@sotsnetwork",
        icon: (
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    <div className="min-h-screen">
      ...
      <main>
        ...
        <Contact 
          ...
          newsletter={portfolioData.contact.newsletter}
