    ...
    <section id="contact" className="relative min-h-screen py-20 px-4 sm:px-6 lg:px-8 bg-black text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 text-left">
          ...
          >
            <h3 className="text-3xl font-bold mb-6 text-white font-['Netflix Sans']">Send a Message</h3>
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label htmlFor="name" className="block text-slate-300 text-sm font-medium mb-2 font-['Netflix Sans']">
                  Name
                </label>
                <input
                  type="text"
                  ...
                  required
                  className="w-full px-4 py-3 bg-slate-700/50 border border-slate-600/50 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-white focus:border-transparent transition-all duration-300 font-['Netflix Sans']"
                  placeholder="Your Name"
                />
              </div>
              <div>
                <label htmlFor="email" className="block text-slate-300 text-sm font-medium mb-2 font-['Netflix Sans']">
                  Email
                </label>
                <input
                  type="email"
              ...
              <div>
                <label htmlFor="subject" className="block text-slate-300 text-sm font-medium mb-2 font-['Netflix Sans']">
                  Subject
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="message" className="block text-slate-300 text-sm font-medium mb-2 font-['Netflix Sans']">
                  Message
                </label>
                <textarea
                  id="message"
              ...
              <motion.button
                type="submit"
                className="w-full px-6 py-3 bg-white text-black font-semibold rounded-lg hover:bg-gray-200 transition-all duration-300 transform hover:scale-105 font-['Netflix Sans']"
          ...
          <div className="space-y-12">
            ...
            <div className="bg-slate-800/30 backdrop-blur-sm p-8 rounded-xl shadow-lg border border-slate-700/50">
              <h4 className="text-2xl font-bold mb-6 text-white font-['Netflix Sans']">Contact Info</h4>
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-slate-300 text-lg font-['Netflix Sans']">{email}</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-12 h-12 bg-white rounded-lg flex items-center justify-center">
                    <svg className="w-6 h-6 text-black" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-slate-300 text-lg font-['Netflix Sans']">Available for Freelance</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-800/30 backdrop-blur-sm p-8 rounded-xl shadow-lg border border-slate-700/50">
              <h4 className="text-2xl font-bold mb-6 text-white font-['Netflix Sans']">Stay Updated</h4>
              ...
              <form onSubmit={handleNewsletterSubmit} className="space-y-4">
                <div>
                  <label htmlFor="newsletter-email" className="block text-slate-300 text-sm font-medium mb-2 font-['Netflix Sans']">
                    Email Address
                  </label>
                  <input
                    type="email"
